...
const Navbar = () => {
  ...
  return (
    <> 
      <div className="fixed left-0 top-0 bg-white w-full z-10 px-4 max-sm:hidden">
        <div className="flex justify-between max-w-7xl mx-auto items-center gap-10">
          ...
          <div className="flex-1 flex justify-center items-center gap-3">
            ...
            <button
              ...
              className=" flex gap-1 justify-center items-center font-semibold hover:text-red-500 cursor-pointer"
            >
